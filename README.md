<!--
  PROFILE README — goes in the repo named exactly: mrkheradmand/mrkheradmand
  GitHub renders this at the top of your profile page automatically.
...
That second part matters more than it sounds. Living with production issues every day —
servers, DNS, deployments, billing systems, customers who are annoyed and right to be —
changes how you write code. You think harder about failure states, logging, and the
person who has to support the thing at 9am on a Monday.

---

### What I'm doing now

- 🏗️ Co-founder of **MassiveCoda**, where I own the Django backend — data modelling,
  business logic, integrations and the release cycle
- 🎧 IT Support Technician at **Subhosting**, handling escalations across hosting,
...
- 🔭 Currently most interested in where AI tooling meets everyday backend work
- 📷 Photographer when I'm not at a keyboard
- 🌍 Persian (native) and English (professional working proficiency)
